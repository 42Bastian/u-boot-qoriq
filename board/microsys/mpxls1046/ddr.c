...
#define MEM_8G (1UL << 33)


#ifdef CONFIG_SYS_DDR_RAW_TIMING
dimm_params_t ddr_raw_timing = {
	.n_ranks = 1,
#ifdef CONFIG_MPXLS1046_MEM_8G
	/* DDR model number: MT40A512M16HX-093E */
	.rank_density = MEM_8G,
	.capacity = MEM_8G,
#elif defined(CONFIG_MPXLS1046_MEM_4G)
	/* DDR model number: MT40A512M16HX-093E */
	.rank_density = MEM_4G,
	.capacity = MEM_4G,
#else
	...
	.n_row_addr = 16,
#endif
#if defined(CONFIG_MPXLS1046_MEM_8G) || defined(CONFIG_MPXLS1046_MEM_4G)
	.n_col_addr = 10,
	.bank_addr_bits = 0,
	.bank_group_bits = 1,
	.edc_config = 2,
