...
// Second NAND Flash definition
#define SYS_NAND2_BASE		0x7e800000 + 0x10000// 0x7d000000
#define SYS_NAND2_BASE_PHYS	SYS_NAND2_BASE
#define SYS_NAND2_CSPR_EXT	(0x0)	// KeiT: war 0x1
#define SYS_NAND2_CSPR	(CSPR_PHYS_ADDR(SYS_NAND2_BASE_PHYS) \
				| CSPR_PORT_SIZE_8	\
				| CSPR_TE \
				| CSPR_MSEL_NAND	\
				| CSPR_V)
#define SYS_NAND2_AMASK	IFC_AMASK(64*1024)
#define SYS_NAND2_CSOR	(CSOR_NAND_ECC_ENC_EN	/* ECC on encode */ \
				| CSOR_NAND_ECC_DEC_EN	/* ECC on decode */ \
				| CSOR_NAND_ECC_MODE_4	/* 4-bit ECC */ \
				| CSOR_NAND_RAL_3	/* RAL = 3 Bytes */ \
				| CSOR_NAND_PGS_2K	/* Page Size = 2K */ \
...
#define CONFIG_SYS_NAND_BASE_LIST	{ CONFIG_SYS_NAND_BASE, SYS_NAND2_BASE }
...
#define CONFIG_SYS_CSPR1_EXT		SYS_NAND2_CSPR_EXT
#define CONFIG_SYS_CSPR1		SYS_NAND2_CSPR
#define CONFIG_SYS_AMASK1		SYS_NAND2_AMASK
#define CONFIG_SYS_CSOR1		SYS_NAND2_CSOR
